// nios2_control_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module nios2_control_mm_interconnect_1 (
	...
	wire  [11:0] slow_periph_bridge_m0_translator_avalon_universal_master_0_address;       // slow_periph_bridge_m0_translator:uav_address -> slow_periph_bridge_m0_agent:av_address
	...
	wire  [11:0] button_pio_s1_agent_m0_address;                                           // button_pio_s1_agent:m0_address -> button_pio_s1_translator:uav_address
	...
	wire  [86:0] button_pio_s1_agent_rf_source_data;                                       // button_pio_s1_agent:rf_source_data -> button_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] button_pio_s1_agent_rsp_fifo_out_data;                                    // button_pio_s1_agent_rsp_fifo:out_data -> button_pio_s1_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_003_src_data;                                                     // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                    // button_pio_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                  // cmd_mux_003:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire  [85:0] button_pio_s1_agent_rp_data;                                              // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [4:0] router_src_channel;                                                       // router:src_channel -> slow_periph_bridge_m0_limiter:cmd_sink_channel
	...
	wire   [4:0] slow_periph_bridge_m0_limiter_cmd_src_channel;                            // slow_periph_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [4:0] rsp_mux_src_channel;                                                      // rsp_mux:src_channel -> slow_periph_bridge_m0_limiter:rsp_sink_channel
	...
	wire   [4:0] slow_periph_bridge_m0_limiter_rsp_src_channel;                            // slow_periph_bridge_m0_limiter:rsp_src_channel -> slow_periph_bridge_m0_agent:rp_channel
	...
	wire   [4:0] slow_periph_bridge_m0_limiter_cmd_valid_data;                             // slow_periph_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	nios2_control_mm_interconnect_1_router router (
	...
	nios2_control_mm_interconnect_1_router_001 router_001 (
	...
	nios2_control_mm_interconnect_1_router_001 router_002 (
	...
	nios2_control_mm_interconnect_1_router_001 router_003 (
	...
	nios2_control_mm_interconnect_1_router_001 router_004 (
	...
	nios2_control_mm_interconnect_1_router_001 router_005 (
	...
	nios2_control_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (altpll_0_c1_clk),                                         //        clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	nios2_control_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (altpll_0_c1_clk),                                         //       clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (altpll_0_c1_clk),                                         //       clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (altpll_0_c1_clk),                                         //       clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (altpll_0_c1_clk),                                         //       clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (altpll_0_c1_clk),                                         //       clk.clk
		.reset              (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_control_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (altpll_0_c1_clk),                                         //       clk.clk
		.reset               (slow_periph_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
